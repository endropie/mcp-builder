...
# [Read the full docs here](https://mcp-builder.com)





## Creating a repository with mcp-builder
...
3. **Define your tool schemas with automatic validation:**
   ...
   import { MCPTool, MCPInput as AddToolInput } from "mcp-builder";
  import { z } from "zod";
...
```typescript
import { MCPTool, McpInput } from "mcp-builder";
import { z } from "zod";
...
```typescript
import { defineSchema } from "mcp-builder";
...
```typescript
import { MCPServer } from "mcp-builder";
...
```typescript
import { MCPServer, JWTAuthProvider } from "mcp-builder";
...
```typescript
import { MCPServer, APIKeyAuthProvider } from "mcp-builder";
...
```typescript
import { AuthProvider, AuthResult } from "mcp-builder";
